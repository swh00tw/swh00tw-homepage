interface PorjectInfo {
  ...
  type: string;
  achievements: string[];
  collaborators: { name: string; github: string }[] | null;
  role: string[] | null;
  framework: string[];
  content: string[];
}

const projects: PorjectInfo[] = [
  {
    name: "My homepage",
    time: "Jan, 2022",
  ...
  },
  {
    ...
    description: [
      "A useful and easy-to-use course management system for NTU students!",
    ],
    ...
    type: "Team project",
    achievements: [
      "1000+ users in 8 hours ✨",
      "2000+ users in 1st week 🎉",
      "First full-stack app",
    ],
    collaborators: [
      { name: "jc-hiroto", github: "https://github.com/jc-hiroto" },
      { name: "Wil0408", github: "https://github.com/Wil0408" },
    ],
  ...
  },
  {
    ...
    description: [
      "A data structure visualization tool for beginner of data structure.",
    ],
    website: null,
    ...
    collaborators: [
      { name: "tin0819tin", github: "https://github.com/tin0819tin" },
      { name: "Ray02250418", github: "https://github.com/Ray02250418" },
    ],
    role: ["Front-end developer"],
